    ...
    <div class="flex flex-col items-center">
        ...
        <div>
            <div class="flex items-center justify-start mt-4">
                <a href="{{route('admin.exercise_guide.create')}}">
            ...
            <table class="shadow-lg bg-white">
                ...
                <tbody>
                    @foreach ($exercises as $exercise)
                        <tr>
                            <td class="border px-8 py-4">{{$exercise->id}}</td>
                            <td class="border px-8 py-4">{{$exercise->name}}</td>
                            <td>
                                <a href="{{ route('admin.exercise_guide.edit',$exercise)}}">
                            ...
                            <td>                        
                                <form class="form-post-admin" action="{{ route('admin.exercise_guide.destroy',$exercise)}}" method="POST">
                                    @csrf
                                    @method('delete')
