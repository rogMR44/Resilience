<x-app-layout>    
    <div class="flex flex-col items-center py-10">
        <h1 class="text-xl font-bold py-2">Products</h1>
        ...
        @endif
        <table class="self-center shadow-lg bg-white max-w-3xl">
            <thead>
                <tr>
                    <th class="border px-8 py-4">ID</th>
                    <th class="border px-8 py-4">Title</th>
                    <th class="border px-8 py-4">Description</th>
                    <th class="border px-8 py-4">Price</th>
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td>                        
                            <form class="form-product-admin" action="{{route('admin.products.destroy',$product)}}" method="POST">
                                @csrf
                                @method('delete')
...
<script>
    $(function () {
        //Prevenir comportamiento del form y redireccionar a la URL para eliminar
        $('.form-product-admin').submit(function (e) {
            e.preventDefault();
            //SWAL
        ...
        swalCustom.fire({
            icon: 'question',
            html: '<strong class="html-message">Are you sure you want to delete the product?</strong>',
            background: '#e9e9e8',
